...
-- Drop functions that may exist from other branches
DROP TRIGGER IF EXISTS job_executions_notify_cancel_trigger ON job_executions;
DROP FUNCTION IF EXISTS notify_job_cancel();
DROP TRIGGER IF EXISTS job_executions_notify_completed_trigger ON job_executions;
